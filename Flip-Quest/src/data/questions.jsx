...
// export const getRandomQuestion = (selectedCategory, numQuestions) => {
//   const categoryQuestions = questions.filter(
//     (index) =>
//       typeof index.category === "string" &&
//       typeof selectedCategory === "string" &&
//       index.category.toLowerCase() === selectedCategory.toLowerCase()
//   );
//   const shuffled = categoryQuestions[0].questions.sort(
//     () => 0.5 - Math.random()
//   ); // Shuffle questions
//   return shuffled.slice(0, numQuestions); // Return selected number of questions
// };
...
export const getRandomQuestion = (selectedCategory, numQuestions) => {
  ...
  if (categoryQuestions.length === 0) {
    return []; // Return an empty array if no questions match the category
  }

  const questionList = categoryQuestions[0]?.questions;
